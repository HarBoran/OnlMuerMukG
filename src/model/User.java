...
public class User {
    ...
    public static void User_Grade(String user_Name, Connection con) {
...
//                        + " \t|" + data.COLUMN_GRADE + " : " + a.getGRADE());
    ...
    public static void User_Rap_Check_Table_Select(ArrayList<OMMG_RAP_CHECK> URCT) {
